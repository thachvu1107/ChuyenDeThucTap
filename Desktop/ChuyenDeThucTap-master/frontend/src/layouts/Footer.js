          ...
          <div className="row">
            ...
            >
              ...
              <ul className="footer-links">
                <li>
                  <a href="#" aria-label="Địa chỉ: 20 Tang Nhon Phu">
                    <i className="fa fa-map-marker" aria-hidden="true"></i> 20 Tang Nhon Phu
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <i className="fa fa-phone" aria-hidden="true"></i> 0325493237
                  </a>
                </li>
                <li>
                  <a
                    href="mailto:vuthach11072004@gmail.com"
          ...
          <div className="row align-items-center">
            <div className="col-12 text-center">
              ...
              <p className="mb-0 copyright">
                &copy; {currentYear} Bản quyền thuộc về Vũ Thạch. Được tạo với{" "}
